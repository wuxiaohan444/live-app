...
Page({
    ...
    onLoad: function(t) {
        var e;
        this.setData((_defineProperty(e = {}, "where.sid", t.sid || 0), _defineProperty(e, "title", t.title || ""), 
        _defineProperty(e, "where.keyword", t.searchValue || ""), _defineProperty(e, "navH", app.globalData.navHeight), 
        e)), this.get_product_list(), this.get_host_product();
    },
    ...
    get_product_list: function(t) {
        ...
        this.setWhere(), s.data.loadend || s.data.loading || (!0 === t && s.setData({
            ...
            loading: !0,
            loadTitle: ""
        }), (0, _goods.getGoodsList)(s.data.where).then(function(t) {
