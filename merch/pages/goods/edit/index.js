var _goods = require("../../../../api/plugin/merch/goods.js"), _util = require("../../../../lib/utils/util"), _util2 = _interopRequireDefault(_util), _dialog = require("../../../../vant/dialog/dialog"), _dialog2 = _interopRequireDefault(_dialog);
...
Page({
    ...
    onReady: function() {},
    onLoadFun: function() {
        var n = this, a = this.data.id, t = _util2.default.getCache("merchGoodsFormData");
        t && 0 < t.id && t.id == a ? n.setData({
            formData: t
        }) : (wx.showLoading(), (0, _goods.goodsInfo)(a).then(function(a) {
            wx.hideLoading();
            var t = a.data, e = [];
            if (t.thumbs) {
                for (var o in t.thumbs) {
                    var i = {
                        url: t.thumbs[o],
                        name: "图片",
                        isImage: !0
    ...
    returnBack: function() {
        _util2.default.getCache("merchGoodsFormData", {});
    ...
    goodsSumit: function(a) {
        ...
        return e.state = a.currentTarget.dataset.state, this.data.loading ? app.Tips({
            title: "请勿重复提交"
        }) : e.title ? e.category_id ? e.store_category_id ? !e.thumbs || e.thumbs.length <= 0 ? app.Tips({
            title: "最少上传一张商品图片"
            ...
            loading: !0
        }), void (0, _goods.updateGoods)(e.id, e).then(function(a) {
