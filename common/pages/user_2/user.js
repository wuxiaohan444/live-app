...
Page(_defineProperty({
    ...
    onLoad: function(e) {
        ...
        }), template.tabbar("tabBar", 3, this), this.setData((_defineProperty(t = {
            themeColor: app.globalData.themeColor
        }, "parameter.bgcolor", app.globalData.themeColor.themeColor), _defineProperty(t, "parameter.textColor", app.globalData.themeColor.text), 
        t));
    },
    onHide: function() {
        this.setData({
